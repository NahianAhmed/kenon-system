...
<div class="row" >
    ...
    <div class="col-6 offset-3"  >
        ...
        <nav class="navbar h5" style="background-color: #edebe6">
        ...
        <div>
            ...
            <form action="/update-forget-password" method="post" class="pl-3">
                ...
                <div class="form-group pt-1">
                    <label for="password">パスワード（６文字以上）</label> <input type="password"
                ...
                <div class="form-group pt-1">
                    ...
                    <label for="cpassword">パスワード（確認用）</label> <input
